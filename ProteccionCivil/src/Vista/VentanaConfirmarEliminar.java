...
public class VentanaConfirmarEliminar extends JDialog implements ActionListener{
	...
	private OyenteVista pCivil;
	private PlanProteccion plan;
	private JTextField txtdeseasEliminarEste;

	private static final String BTN_ELIMINAR_PLAN = "Eliminar";
	private static final String BTN_CANCELAR = "Cancelar";
	/**
	 * Create the dialog.
	 */
	public VentanaConfirmarEliminar(OyenteVista pCivil, PlanProteccion plan) {
		this.pCivil = pCivil;
		setTitle("Confirmar Eliminar Plan");
		...
		getContentPane().add(contentPanel);
		{
			...
			textPane.setText(plan.toString());
		}
		{
			...
			getContentPane().add(panel, BorderLayout.SOUTH);
			{
				...
				btnEliminar.setActionCommand(BTN_ELIMINAR_PLAN);
		...
		}
		{
			...
			panel.setLayout(new BorderLayout(0, 0));
			{
				...
				txtdeseasEliminarEste.setText("\u00BFDeseas eliminar este plan de protecci\u00F3n?");
	...
	public void actionPerformed(ActionEvent e) {
		...
		case BTN_CANCELAR:
			...
			this.dispose();
			break;
		case BTN_ELIMINAR_PLAN:
			System.out.println("confirmar eliminar");
			pCivil.notificacion(OyenteVista.Evento.ELIMINAR_PLAN,plan);
			this.dispose();
			break;
		}
