...
public class MapaVista extends JLabel{
    ...
    private Map<String, Alerta> alertasActivas;
    String opcs = "path=42.245333,0.423957&";
    
    public MapaVista() {
        setVisible(true);
        contadorAlertas = 0;
        alertasActivas = new HashMap<String, Alerta>();
    ...
    public void introducirAlerta(Alerta alerta){
        if(buscarAlerta(alerta) == null){
            alertasActivas.put(alerta.informacion(), alerta);
       };
    }
    ...
    public Alerta buscarAlerta(Alerta alerta){
        return alertasActivas.get(alerta.informacion());
    }
    /**
     * Pone un marcador en el mapa
     */
    public void introducirMarcadores(double x, double y, String marcador){
        contadorAlertas++;
    ...
    */
    public void visualizarMapa(String opciones) {
        ...
        if(conexion){
            ...
            Icon icono = new ImageIcon(icon.getImage().getScaledInstance(700, 700, 0));
            setIcon(icono);  
        }
    }
